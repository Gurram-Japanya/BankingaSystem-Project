...
customerNames = ['Japanya', 'Chintu', 'Chinnu', 'Triveni','Kumari','Gurram']
customerPins = ['0123', '2575', '7275', '2312', '5049', '9014']
customerBalances = [10000, 20000, 20000, 40000, 10000, 25000]
deposition = 0
withdrawal = 0
balance = 0
counter_1 = 1
...
# This while statement below helps the program to run continuously.
while True:
    # os.system("cls")
    print("=====================================")
    ...
    if choiceNumber == "1":
        ...
        # This statement below helps the user to go back to the start of the program (main menu).
        mainMenu = input("Please press enter a key to go back to main menu to perform another function or exit ...")